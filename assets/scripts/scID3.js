monogatari.label('idPart3-1', 'Indonesia', [
  ...
  'Di negara yang bernama Jepang, seorang pria bernama YAGOO. CEO dari COVER corp, pemilik Agensi V-Tuber Hololive sedang gunda gulana karena impiannya terus dihancurkan oleh talent yang ia miliki.',  
  ...
  "play voice Yagoo_02",
  'yagoo Sepertinya aku tidak bisa mengharapkan mereka untuk mewujudkan impianku membentuk V-Idol yang setara dengan AKB-48, bahkan sekarang banyak orang yang menyebut mereka sebagai AK-47.',
  ...
  'Iofi pun mengambil selebaran yang dibagikan tersebut dan membawanya pulang.',
  "stop sound city",
  ...
  'iofi Setelah membaca selebaran ini, kok rasa percaya diriku jadi hilang ya?',
  ...
  'mchan Iya... Selamat yah..... Untuk informasi lebih lanjut, akan kami hubungi dalam beberapa hari ke depan.',
  "play music M-chan with loop volume 5",
  ...
  "play voice King_22",
  'raja Para Prajurit! Bersiaplah di posisi kalian. Ini akan menjadi pertempuran yang sulit. Tapi tunjukkan bahwa Iolyptus adalah bangsa yang merdeka, tidak takut kepada kekaisaran.',
  "play voice King_23",
