monogatari.label("enPart2", "English", [
  ...
  "play voice King_11",
  "king My daughter, hear me out, I have something really important to tell you. A few days ago an envoy came from the Galactic Emperor to propose to you. The Emperor wants you as one of His mistresses.",
  ...
  "The Queen broughts the Second Princess out of the dining room.",
  "play music IofiParentDecision with loop volume 10",
  "play voice King_13",
  "king Hear me, my child, the Emperor didn’t give me any other choice. If I refuse, he will declare a war to the Iolyptos. I am forced to agree with this.",
  ...
  "that the Emperor told a proposal which also threatens Iolyptos if the King refuses it.",
  ...
  "firstPrincess If Father is really going to make a political tool out of me, then I will run away from Iolyptos!",
  ...
  "The Princess decided that night, that she must run away from Iolyptos by a spacecraft she usually uses.",
  ...
  "play voice King_18",
  "king Bring this thing with you, I am unable to think clearly knowing that all of you will be in danger.",
  "show character ratu bingung2 at left",
  "play voice Queen_05",
  "queen Isn’t this thing coming in pairs? Did My King hold the other one?",
  "play voice King_19",
  "king I hid it in the spacecraft she usually uses, this thing will be able to connect you no matter how far you are from each other.",
  "hide character ratu bingung2 at left with fadeOut",
  ...
  "firstPricess I just ran away from Iolyptos, but now I don’t know where should I go...",
...
monogatari.label('coklat', 'English', [
  ...
  "firstPricess Hm?! What is this thing? I don’t remember bringing it with me.",
...
monogatari.label('enPart2-2', 'English', [
  ...
  "wait 1000",
  "After some time has passed, the Princess finally saw a beautiful blue planet from a distance. She decided that she will be heading there as her destination.",
  ...
  "coro To all units that are near the detected target. Prepare to surround it!",
  "hide character kecoa normal with fadeOut",
  "The spacecraft she is riding got detected by the radar from Area 15.",
  "stop music MenInBlackTheme fade 5",
  "play music UFOLanding with loop volume 10",
  "play sound Beach with loop volume 10",
  "show scene beach with fadeIn",
  "wait 1000",
  "show character putriPertama talking with fadeIn",
  "firstPricess I have finally arrived, but where am I? I will just ask the inhabitants of this planet when meet them.",
  ...
  "In an instant, she is surrounded by agents in black suits, then she got captured and brought to Area 15 for an interrogation.",
  "stop sound Beach",
  ...
  "play sound lampon",
  "show character putriPertama cemashijau",
  "show character mib1 normal at left",
  "show character mib2 normal at right",
  "play music MenInBlackTheme with loop volume 10",
  ...
  "horse Tie her to the chair, don’t let her get away.",
  ...
  "horse She can talk inside my head, this is dangerous! Agent Kecoa, shoot her with a stun gun.",
  "Agent Kecoa starts aiming her stun gun at the First Princess.",
  ...
  "horse WAKE UP!!! Looks like this will be too dangerous if we do nothing about it. I'm going to immobilize both of you. I’m sorry, Agent Kecoa.",
  "show character kuda closeeye at left with slideInRight",
  "play sound AgenKudaReload",
  "Agent Kuda, who finds himself in a dangerous situation, tries to immobilize Agent Kecoa.",
  ...
  "But the bullet that Agent Kuda shot is being blocked by something invisible, making both First Princess and Agent Kecoa unharmed.",
  "show character kuda closeeye at left with fadeIn",
  "show character kecoa hypnotize at right with fadeIn",
  "show character putriPertama netral at protect with fadeIn",
  ...
  "hide character kuda closeeye at left with fadeOut",
  "hide character kecoa hypnotize at right with fadeOut",
  "hide character putriPertama netral at protect with fadeOut",
  "Agent Kuda gives the Princess a chance to talk.",
  "show character kuda mata at left with fadeIn",
  "show character putriPertama netralhijau with fadeIn",
  "play voice Agen-Kuda_09",
  "horse So, what is your purpose for coming to the Earth?",
  ...
  "From that interrogation it is known that the First Princess has \"Barrier\", \"Telepathy\", and \"Brainwash\" abilities.",
  ...
  "coro To think that you could only speak in Iolyptos's language before.",
  "hide character kuda normal at left with fadeOut",
  ...
  "With her ability to learn different languages really fast, in a few months she is already speaking Indonesian.",
  "show character kuda normal at left with fadeIn",
  "show character kecoa normal at right with fadeIn",
  "play voice Agen-Kuda_13",
  "horse After thinking for a while, we have agreed to give you a name.",
  ...
  "hide character putriPertama smile with fadeOut",
  "And so they gave the Princess a new name, that is \"Airani Iofifteen\"",
  "show character kuda normal at left with fadeIn",
  "show character kecoa closeeye at right with fadeIn",
  "play voice Agen-Kuda_15",
  "horse After few months of watching over you, it looks like you have no evil intentions at all.",
  "play voice Agen-Kecoak_06",
  "coro And because of that, Area 15 will categorize you as a Harmless Alien. So we will let you live normally, as a proper human does.",
  "hide character kuda normal at left with fadeOut",
  ...
  "horse Don’t be too happy now, we are still watching over you, even though it’s not going to be as strict as before.",
  ...
  "iofi I want to learn a lot about science that humans have; it’s said that mathematics is the highest degree out of all sciences.",
  "iofi But I’m not that good with mathematics... Maybe I’ll learn arts! If someday I'll travel around the world I could paint the views that I’m seeing!",
  ...
  'hide image phone center hp with fadeOut',
  "After selling some valuable items from Iolyptos at Pasar Senen, Iofi intended to study as an art college student while learning all kinds of languages that humans on Earth use.",
