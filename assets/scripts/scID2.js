monogatari.label('idPart2', 'Indonesia', [
  ...
  "ratu Tapi, Rajaku...",
  "hide character raja normal at left with fadeOut",
  ...
  "hide character putriPertama normal with fadeOut",
  "show character raja normal with fadeIn",
  "raja Tidak ada tapi! Kembali keruanganmu sekarang!",
  "hide character raja normal with fadeOut",
  ...
  "hide character putriPertama normal with fadeOut",
  "show scene #000",
  "centered Hanggar Pesawat",
  "show scene runway with fadeIn",
  "show character putriPertama normal with fadeIn",
...
monogatari.label('idPart2-2', 'Indonesia', [
  ...
  "kecoa <i>Jika itu keinginanmu, Tuan Putri</i>",
  ...
  "putriPertama Ehehe...~⭐",
  "hide character putriPertama normal with fadeOut",
  "Dan kemampuanya dalam mempelajari bahasa, sangat luar biasa cepat hanya dalam waktu beberapa bulan, dia sudah bisa berbicara bahasa Indonesia.",
  "show character kuda normal at left with fadeIn",
  "show character kecoa normal at right with fadeIn",
